...
im.ggplotRGB <- function(input_image, r = 1, g = 2, b = 3, maxpixels = 1e+06, main = NULL) {
  ...
  # If main is not NULL, add a title to the plot
  if (!is.null(main)) {
    p <- p + ggtitle(main)
  }
...
im.ggplotRGB(mato,  r = 1, g = 2, b = 3, main = "ejjde")
